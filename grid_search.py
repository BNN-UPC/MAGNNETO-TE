...
#MULTI-AGENT
num_actions = [1,2,3,5,10]
horizons = [(25,50),(50,100),(75,150),(100,200)]
                                                                    ...
                                                                    for num_action in num_actions:
                                                                        for horizon in horizons:
                                                                            cmd = "python ./run.py" \
                                                                                ...
                                                                                " --gin_bindings='PPOAgent.default_NSFNet_horizon = "+str(horizon[0])+"'" \
                                                                                " --gin_bindings='PPOAgent.default_GEANT2_horizon = "+str(horizon[1])+"'" \
