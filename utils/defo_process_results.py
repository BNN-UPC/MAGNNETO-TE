...
def get_link_utilization(list_of_results):
    return [item for sublist in [[value for value in list_of_results[i].values()] for i in range(len(list_of_results))] for item in sublist]
